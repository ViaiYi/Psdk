...
/* Private values -------------------------------------------------------------*/
GPIO_TypeDef *s_ledPort[LED_NUM] = {LED1_GPIO_PORT, LED2_GPIO_PORT, LED3_GPIO_PORT, LED4_GPIO_PORT, LED5_GPIO_PORT};
const uint16_t s_ledPin[LED_NUM] = {LED1_GPIO_PIN, LED2_GPIO_PIN, LED3_GPIO_PIN, LED4_GPIO_PIN, LED5_GPIO_PIN};
