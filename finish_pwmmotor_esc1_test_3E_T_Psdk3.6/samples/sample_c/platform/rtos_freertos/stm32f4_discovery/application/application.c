...
extern TIM_HandleTypeDef g_timx_motor_chy_handle;
...
//     uint8_t dir = 1;
    //gtim_timx_pwm_chy_init(500-1,840-1);
//     //led_init();                                 /* ��ʼ��LED */

    gtim_timx_pwm_chy_init(2000 - 1, 840 - 1);    /* 84 000 000 / 84 = 1 000 000 1Mhz�ļ���Ƶ�ʣ�2Khz��PWM */
    uint32_t value;
    while (1)
    {
...
//         /*
//         // ����PWMռ�ձ���ʵ�ֺ�����Ч��
//         __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, TIM_CHANNEL_1, currentBrightness);
...
//         currentBrightness += direction * step;
            value = 2000 - 60 - DjiUser_GetValue( 3 , 5);
            //gtim_timx_pwm_chy_init(2000 - 1, 840 - 1);
    //gtim_timx_motor_chy_init(2000 - 1, 840 - 1); 
            
            // for(value = 100 ; value<500 ; value+=10){
            __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, value);
            vTaskDelay(2000);
            printf("%d",value);

            // }
            ///__HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 2000-);

            
            Led_Trigger(LED4);

//         vTaskDelay(100); // �����Ʊ仯�ٶȿ���
...
//         */
        ...
        //value = 200-DjiUser_GetValue( 3 , 5)*2;
//         //USER_LOG_INFO("value:%d",value);
        // __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 100 );
        // vTaskDelay(10000);
        // __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 150 );
        // vTaskDelay(10000);
...
void DjiUser_LedPwmTask(void const *argument){
    gtim_timx_motor_chy_init(200 - 1, 8400 - 1);    /* 84 000 000 / 84 = 1 000 000 1Mhz�ļ���Ƶ�ʣ�2Khz��PWM */
    uint32_t value;
    while (1){
        value = 200 - DjiUser_GetValue( 3 , 3)*2;
//         //USER_LOG_INFO("value:%d",value);
        __HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, value );
        Led_On(LED4);
        vTaskDelay(100);
...
//     vTaskDelay(1000);
//     __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 100);
//     //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 100);
//     printf("1\n");
//     vTaskDelay(10000);
//     __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY,150 );
//     //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 150);
//     printf("2\n");
//     vTaskDelay(10000);
//     __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 200 );
//     //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 150);
...
//     // vTaskDelay(1000);
//     // __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 2000-100);
//     // //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 100);
//     // printf("1\n");
//     // vTaskDelay(10000);
//     // __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY,2000-150 );
//     // //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 150);
//     // printf("2\n");
//     // vTaskDelay(10000);
//     // __HAL_TIM_SET_COMPARE(&g_timx_pwm_chy_handle, GTIM_TIMX_PWM_CHY, 2000-200 );
//     // //__HAL_TIM_SET_COMPARE(&g_timx_motor_chy_handle, GTIM_TIMX_MOTORPWM_CHY, 150);
//     // vTaskDelay(10000);
//     // printf("3\n");
//     // Led_On(LED4);
