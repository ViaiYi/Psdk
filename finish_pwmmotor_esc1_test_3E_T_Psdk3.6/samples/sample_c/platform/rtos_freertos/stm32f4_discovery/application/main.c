...
/* My Task -------------------------------------------------------------------*/
#define USER_MOTORPWM_TASK_STACK_SIZE         256
#define USER_MOTORPWM_TASK_PRIORITY           0

#define USER_LEDPWM_TASK_STACK_SIZE         256
#define USER_LEDPWM_TASK_PRIORITY           0
...
static TaskHandle_t motorPwmTask;
static TaskHandle_t ledPwmTask;
...
int main(void)
{
    ...
    /* Create motorPwm Task */
    xTaskCreate((TaskHandle_t) DjiUser_MotorPwmTask, "motorPwm_task", USER_MOTORPWM_TASK_STACK_SIZE,
                NULL, USER_MOTORPWM_TASK_PRIORITY, (TaskHandle_t *) motorPwmTask);

    /* Create ledPwm Task */
    xTaskCreate((TaskHandle_t) DjiUser_LedPwmTask, "ledPwm_task", USER_LEDPWM_TASK_STACK_SIZE,
                NULL, USER_LEDPWM_TASK_PRIORITY, (TaskHandle_t *) ledPwmTask);
